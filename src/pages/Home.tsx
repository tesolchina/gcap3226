          ...
          <Card className="p-5 sm:p-6 md:p-8 hover:shadow-2xl transition-all active:scale-[0.98] md:hover:scale-[1.02] bg-gradient-to-br from-primary/10 via-card to-accent/20 border-primary/30 border-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold">Fall 2026</h2>
              </div>
            </div>
            <p className="text-muted-foreground mb-6">
              Course portal for the upcoming Fall 2026 cohort. Preparing in advance: 10 project topics and an AI tutor ready.
            </p>
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Users className="h-4 w-4" />
                <span>10 project topics</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <BookOpen className="h-4 w-4" />
                <span>AI tutor (course + per-topic)</span>
              </div>
            </div>
            <Button asChild className="w-full" size="lg">
              <Link to="/fall-2026">
                Enter Fall 2026 Portal
          ...
          <Card className="p-5 sm:p-6 md:p-8 hover:shadow-xl transition-all active:scale-[0.98] md:hover:scale-[1.02] bg-gradient-to-br from-muted/50 via-card to-accent/10 border-muted">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold text-muted-foreground">Spring 2026</h2>
              </div>
            </div>
            <p className="text-muted-foreground mb-6">
              Password-protected archive of the Spring 2026 cohort — projects, presentations and weekly modules.
            </p>
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Users className="h-4 w-4" />
                <span>Spring 2026 teams</span>
              </div>
            </div>
            <Button asChild variant="outline" className="w-full" size="lg">
              <Link to="/spring-2026">
                View Spring 2026 Archive
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </Card>
