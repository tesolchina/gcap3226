...
const weekContent: Record<string, { title: string; description: string; objectives: string[]; activities: string[]; techSetup?: { tools: string[]; support: string[] }; inClassExercise?: { title: string; description: string; dataset: string; skills: string[] }; assessment?: string; assessmentLink?: string }> = {
  ...
  "5": {
    title: "First Group Consultation & Fieldwork Planning",
    description: "Small group consultation meetings with teachers to discuss project progress, prepare for fieldwork, and set clear expectations for Week 6 field activities.",
    objectives: [
      "Participate in small group consultation with assigned teacher",
      "Discuss project progress and receive feedback",
      "Prepare detailed fieldwork plan for Week 6",
      "Understand fieldwork expectations, safety, and ethics",
      "Set project milestones toward the final report",
    ],
    activities: [
      ...
      "Review project milestones and timeline",
      "Prepare fieldwork materials and logistics",
    ],
  ...
  "6": {
    ...
    description: "Conduct fieldwork to collect primary data for your group project. Apply the plans and protocols discussed in Week 5. Note: This week includes a public holiday.",
    objectives: [
      "Execute fieldwork plans developed in Week 5",
      "Conduct interviews, observations, or surveys",
      "Collect primary data ethically and effectively",
      "Document fieldwork experiences and challenges",
    ],
    activities: [
      "Fieldwork execution in the field",
      "Primary data collection (interviews, observations, surveys)",
