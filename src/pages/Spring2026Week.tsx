...
const weekContent: Record<string, { title: string; description: string; objectives: string[]; activities: string[]; techSetup?: { tools: string[]; support: string[] }; inClassExercise?: { title: string; description: string; dataset: string; skills: string[] }; assessment?: string; assessmentLink?: string }> = {
  ...
  "5": {
    title: "Data Governance & Request Preparation",
    description: "Learn about data governance concepts. Participate in group consultation to review and discuss draft data request letters before sending them in Week 6.",
    objectives: [
      "Understand data governance principles and their importance in policy research",
      "Participate in small group consultation with assigned teacher",
      "Draft government data request letters for review",
      "Learn about the Code on Access to Information",
      "Prepare for sending information requests in Week 6",
    ],
    activities: [
      "Data governance lecture and discussion",
      "Small group consultation meeting (teacher-led discussion)",
      "Draft data request letters workshop",
      "Review and refine request letters with peer feedback",
      "Self-study: Government Info Requests module",
    ],
    techSetup: {
      tools: [
      ...
      support: [
        "Draft request letters should be ready for Week 5 consultation",
        "Teachers will review and provide feedback on your drafts",
        "Prepare questions about data governance for discussion",
        "Check existing public data sources before requesting",
      ],
    },
  ...
  "6": {
    title: "Send Information Requests & Fieldwork Prep",
    description: "Finalize and send data request letters to government departments. Prepare for fieldwork activities. Note: 18 Feb is a public holiday.",
    objectives: [
      "Send finalized data request letters to government departments",
      "Prepare detailed fieldwork plan for Week 7",
      "Understand fieldwork expectations, safety, and ethics",
      "Begin exploring publicly available data sources",
    ],
    activities: [
      "Send data request emails to government departments",
      "Fieldwork planning and expectation setting",
      "Discuss interview/observation protocols",
      "Curate publicly available data for your topic",
      "Team coordination for fieldwork logistics",
    ],
  },
  "7": {
