...
const assessments = [
  {
    ...
    link: "/spring-2026/assessments/in-class-exercise-1",
    icon: ClipboardCheck,
    color: "bg-blue-500",
  },
  {
    ...
    link: "/spring-2026/assessments/in-class-exercise-2",
    icon: ClipboardCheck,
    color: "bg-blue-500",
  },
  {
  ...
  },
  {
    ...
    week: "Week 7",
    weight: "Part of 20%",
    description: "Reflect on government data transparency and AI collaboration experiences.",
  ...
  },
  {
    ...
    link: "/spring-2026/assessments/presentation-1",
    icon: Presentation,
    color: "bg-purple-500",
  },
  {
    ...
    link: "/spring-2026/assessments/presentation-2",
    icon: Presentation,
    color: "bg-purple-500",
  },
  {
    id: 8,
    title: "Final Report & Poster",
    type: "Group",
    week: "Week 13",
    weight: "30%",
    description: "Comprehensive group project report (~3,000 words) and poster for LegCo submission.",
  ...
  },
  {
    ...
    week: "Week 12",
    weight: "20%",
    description: "Document your AI tool usage and collaboration throughout the course (1,000 words).",
