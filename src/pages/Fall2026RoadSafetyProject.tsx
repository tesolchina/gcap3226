  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background p-4 sm:p-6 md:p-8">
      <div className="max-w-5xl mx-auto space-y-4 sm:space-y-6">
        ...
        <Card className="p-4 sm:p-6 border-l-4 border-l-primary">
          ...
          <p className="text-sm text-muted-foreground italic">
            ...
            <strong className="text-foreground not-italic">
              I may leave this task to GCAP3226 students next semester.
            </strong>
            "
          </p>
        ...
        {/* Overview */}
        <SectionCard icon={FileSpreadsheet} title="Project overview">
          <p className="text-sm sm:text-base text-muted-foreground">
            A live research strand handed down from the Spring 2026 TA team (Yingxin HUANG & Zehua
            WANG, supervised by Dr Tian WU). The dataset is already cleaned to annual granularity;
            21 junctions are pre-selected; 8 geometry independent variables are collected. Your
            team picks a sub-question, runs the analysis, and turns it into a policy-relevant
            deliverable mirroring the Spring 2026 final-report format.
          </p>
        </SectionCard>

        {/* AI tutor — primary chat surface */}
        <Card className="p-0 overflow-hidden border-primary/30">
          <div className="bg-primary/5 px-4 sm:px-6 py-3 border-b flex items-center gap-2">
            <Sparkles className="h-4 w-4 text-primary" />
            <h2 className="font-semibold">Chat with your project AI tutor</h2>
          </div>
        ...
        {/* Established facts */}
        <SectionCard icon={FileSpreadsheet} title="What is already established">
        ...
        {/* Hotspots */}
        <SectionCard icon={MapPin} title="Anchor hotspots (2015–2024)">
        ...
        {/* Research questions */}
        <SectionCard icon={Target} title="Key research questions (pick one)">
        ...
        {/* Data sources */}
        <SectionCard icon={ExternalLink} title="Data sources">
          <ul className="space-y-2">
            {DATA_SOURCES.map((s) => (
        ...
        {/* Team / meetings / milestones / files — inline */}
