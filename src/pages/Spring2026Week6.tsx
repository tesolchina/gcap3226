...
import { FileText, ExternalLink, AlertCircle, Bot, Github } from "lucide-react";
        ...
        <div className="space-y-6">
          ...
          <Alert className="border-amber-300 bg-amber-50 dark:bg-amber-950/30 dark:border-amber-700">
            ...
            <AlertDescription className="text-amber-700 dark:text-amber-300">
              Please open your team's Google Doc and <strong>request edit access</strong> so you can collaborate on the fieldwork documentation.
            </AlertDescription>
          </Alert>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">Team Fieldwork Documents</h2>
            </div>
            <div className="space-y-3">
              {teamDocs.map((doc) => (
                ...
                >
                  <div>
                    <p className="font-medium">{doc.team}</p>
